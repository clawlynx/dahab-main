    ...
    <div className="w-full bg-white xl:bg-gradient-to-r from-profitYellow2 from-50% to-profitYellow1 to-50% flex justify-around rounded-lg items-center shadow-2xl shadow-gray-400 p-5">
      <div className="flex flex-col gap-10">
        <div className="flex flex-col gap-3">
          <h1 className="text-sm lg:text-2xl font-semibold">Purchase BTC</h1>
          <h1 className="text-base lg:text-[28px] font-bold">57,765 BTC</h1>
        </div>
        <div className="flex flex-col gap-3">
          <h1 className="text-sm lg:text-2xl font-semibold">
            Direct BTC Quality
          </h1>
          <h1 className="text-base lg:text-[28px] font-bold">0.12118046 BTC</h1>
        </div>
      </div>
      ...
      <div className="flex flex-col items-end gap-10">
        <div className="flex flex-col gap-3 items-end">
          <h1 className="text-sm lg:text-2xl font-semibold">Mining BTC</h1>
          <h1 className="text-base lg:text-[28px] font-bold text-[#1ECBAF] xl:text-white">
            45,889.53 USD
          </h1>
        </div>
        <div className="flex flex-col gap-3 items-end">
          ...
          <h1 className="text-base flex lg:flex-row flex-col gap-3 items-end lg:items-center lg:text-[28px] font-bold text-[#1ECBAF] xl:text-white">
            0.14323456 BTC{" "}
